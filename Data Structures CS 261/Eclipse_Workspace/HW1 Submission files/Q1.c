...
/* Name: Xiao Kuang
 * Date:1/20/2019
 * Solution description: This program demonstrates dynamically allocating memory using malloc(),
 * generating random numbers, and freeing any allocated memory.  Each ID is unique, but randomly assigned,
 * each ID's score is randomly assigned but not unique.  Minimum, maximum, and averages are printed.
 */
